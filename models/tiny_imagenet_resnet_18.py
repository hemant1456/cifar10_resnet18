...
class resnet18(nn.Module):
    def __init__(self,n_classes=200):
        ...
        #resblock1
        self.res_block1 = resnet_block(64)
        self.res_block2 = resnet_block(128)
        self.res_block3 = resnet_block(256)
        self.res_block4 = resnet_block(512)

        self.gap = nn.AdaptiveAvgPool2d((1,1))

        self.conv2 = nn.Conv2d(1024,n_classes,1,1,0)
